...
const getCaption = obj => (`Електронний протокол ${obj.number_doc} від ${obj.date}`);


const EpType = new GraphQLObjectType({
  name: 'ElProtocol',
  description: 'Електронний протокол',
  args: {
