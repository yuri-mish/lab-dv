...
export const RejectionPath = (props) => {
  const {
    handleChange = () => {},
    handlePopupClose = () => {},
    data = {},
  ...
  const validationGroupName = 'rejectionPath';
  ...
  return (
    <div className={styles.form_wrapper}>
      ...
      <h2 className={styles.form_title}>
        {'Відхилення реєстрування шляху не більше ніж, на ділянці дороги ' +
          'довжиною щонайменше 1 кілометр'}
      </h2>
